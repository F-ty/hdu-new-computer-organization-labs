# HDU 新版计算机组成原理实验代码（实验 3–12）

本仓库整理杭州电子科技大学（HDU）新版计算机组成原理 FPGA 实验 3–12 的代码，面向 Vivado 与 HCS_A02 开发板。仓库只保留 HDL 源码、仿真文件、约束文件和程序初始化文件；Word/PDF 报告、Vivado 缓存、综合实现结果与比特流均不纳入版本控制。
