## HCS-A02 / XC7A100T-CSG324-2L constraint file for Experiment 9
## Top module: top_exp9

## 100 MHz system clock
set_property PACKAGE_PIN E3 [get_ports clk_100m]
set_property IOSTANDARD LVCMOS33 [get_ports clk_100m]
create_clock -add -name sys_clk_pin -period 10.000 -waveform {0 5} [get_ports clk_100m]

## Buttons: pressed = logic 1
## BT0: single-step; BT1: reset
set_property PACKAGE_PIN D15 [get_ports btn_step]
set_property IOSTANDARD LVCMOS33 [get_ports btn_step]
set_property PACKAGE_PIN C10 [get_ports btn_reset]
set_property IOSTANDARD LVCMOS33 [get_ports btn_reset]

## Display selector switches SW2..SW0
...
## Eight-digit common-anode display digit enables AN7..AN0, active low
...
## Segment outputs, seg={CA,CB,CC,CD,CE,CF,CG,DP}, active low
